...
<<strongsomatic, echo=FALSE, results='asis'>>=
  ...
  if(dim(tts)[1]==0) {
    cat('No results')
      ...
      Rtab <- xtable(tts[,c(1,2,4,12,6,5,7,8)], align=c("l","p{1.25cm}","p{2cm}","p{1cm}","p{3.5cm}","p{0.25cm}","p{1.75cm}","p{1.25cm}","p{2.25cm}"))
...
<<additionalVariants, echo=FALSE, results='asis'>>=
  ...
  tta <- subset(tt, Interpretation!='pathogenic' & Interpretation!='VUS likely pathogenic')
  colnames(tta)[12] <- 'Consequence'
  if(dim(tta)[1]==0) {
    cat('No results')
  } else {
    Rtab <- xtable(tta[,c(1,2,4,12,6,5,7,8)], align=c("l","p{1.25cm}","p{2cm}","p{1cm}","p{3.5cm}","p{0.25cm}","p{1.75cm}","p{1.25cm}","p{2.25cm}"))
...
<<patho, echo=FALSE, results='asis'>>=
  if(exists('pathoTab')) {
   ...
   if(dim(pathoTab)[1]==0) {
    ...
    Rtab <- xtable(pathoTab, align=c("l","p{1cm}","p{1.5cm}","p{1.5cm}","p{1cm}","p{1cm}","p{1cm}","p{6.25cm}"))
